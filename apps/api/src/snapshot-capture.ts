...
const TABLES: TableDef[] = [
  ...
  // Coverage 2026-08-19 sample data
  { name: "vendor", fileName: "vendors.json" },
  { name: "purchaseOrder", fileName: "purchase-orders.json" },
  { name: "pOLineItem", fileName: "po-line-items.json" },
  { name: "report", fileName: "reports.json" },
  { name: "reportSchedule", fileName: "report-schedules.json" },
  { name: "survey", fileName: "surveys.json" },
  { name: "surveyQuestion", fileName: "survey-questions.json" },
  { name: "surveyResponse", fileName: "survey-responses.json" },
  { name: "surveyAnswer", fileName: "survey-answers.json" },
  { name: "ptoRequest", fileName: "pto-requests.json" },
  { name: "holiday", fileName: "holidays.json" },
  { name: "contract", fileName: "contracts.json" },
  { name: "contractMilestone", fileName: "contract-milestones.json" },
  { name: "salesActivity", fileName: "sales-activities.json" },
  { name: "kBCategory", fileName: "kb-categories.json" },
  { name: "chatSession", fileName: "chat-sessions.json" },
  { name: "chatMessage", fileName: "chat-messages.json" },
  { name: "workflowRule", fileName: "workflow-rules.json" },
  { name: "workflowRuleAction", fileName: "workflow-rule-actions.json" },
  { name: "workflowExecution", fileName: "workflow-executions.json" },
