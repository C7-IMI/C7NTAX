...
const SEED_ORDER: { fileName: string; model: string }[] = [
  ...
  // Coverage 2026-08-19 (parents before children)
  { fileName: "vendors.json", model: "vendor" },
  { fileName: "purchase-orders.json", model: "purchaseOrder" },
  { fileName: "po-line-items.json", model: "pOLineItem" },
  { fileName: "reports.json", model: "report" },
  { fileName: "report-schedules.json", model: "reportSchedule" },
  { fileName: "surveys.json", model: "survey" },
  { fileName: "survey-questions.json", model: "surveyQuestion" },
  { fileName: "survey-responses.json", model: "surveyResponse" },
  { fileName: "survey-answers.json", model: "surveyAnswer" },
  { fileName: "pto-requests.json", model: "ptoRequest" },
  { fileName: "holidays.json", model: "holiday" },
  { fileName: "contracts.json", model: "contract" },
  { fileName: "contract-milestones.json", model: "contractMilestone" },
  { fileName: "sales-activities.json", model: "salesActivity" },
  { fileName: "kb-categories.json", model: "kBCategory" },
  { fileName: "chat-sessions.json", model: "chatSession" },
  { fileName: "chat-messages.json", model: "chatMessage" },
  { fileName: "workflow-rules.json", model: "workflowRule" },
  { fileName: "workflow-rule-actions.json", model: "workflowRuleAction" },
  { fileName: "workflow-executions.json", model: "workflowExecution" },
